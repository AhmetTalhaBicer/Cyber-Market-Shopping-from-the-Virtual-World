...
let CartController = class CartController {
    ...
    async addProduct(id, addProductDto) {
        try {
            const updatedCart = await this.cartService.addProduct(+id, addProductDto);
            return {
                success: true,
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Add a product to a cart' }),
    (0, swagger_1.ApiResponse)({
        status: 201,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_c = typeof create_cart_dto_1.CreateCartDto !== "undefined" && create_cart_dto_1.CreateCartDto) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_d = typeof update_cart_dto_1.UpdateCartDto !== "undefined" && update_cart_dto_1.UpdateCartDto) === "function" ? _d : Object]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b239eacb27c63df4667b")
/******/ })();
/******/ 
/******/ }
;