...
let CartController = class CartController {
    ...
    async calculateTotal(cart_id) {
        return this.cartService.calculateTotal(cart_id);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Add an item to a cart' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Remove an item from a cart' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("fde22ccdd0a9cb2f6d79")
/******/ })();
/******/ 
/******/ }
;